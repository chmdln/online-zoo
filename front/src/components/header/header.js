...
export function renderHeader() {
    ...
    return `
        <header>
            ...
            <div class="container-right">
                ...
                <div class="social-media">
                    <a href="https://www.youtube.com/@RSSchool" target="_blank">
                        <img src="${BASE_PATH}/images/youtube.png" alt="Youtube Logo">
                    </a>
                    <a href="https://www.instagram.com/rsschool_en/" target="_blank">
                        <img src="${BASE_PATH}/images/instagram.png" alt="Instagram Logo">
                    </a>
                    <a href="https://www.facebook.com/rsschoolEN/" target="_blank">
                        <img src="${BASE_PATH}/images/facebook.png" alt="Facebook Logo">
                    </a>
                </div>
            </div>
            <div class="user-container">
                <div class="user-icon">
                    <img src="${BASE_PATH}/icons/user.svg" alt="User icon">
                </div>
            ...
            <img 
                src="${BASE_PATH}/icons/burger.svg" alt="Hamburger icon"
